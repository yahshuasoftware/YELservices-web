...
import RationService from "../Component/Dashboard/RationService";
import ElectionService from "../Component/Dashboard/ElectionService";
  ...
  return (
    <Routes>
      ...
      <Route path="/dashbord" element={<Dashbord />}>
        ...
        <Route path="ration" element={<RationService />} />
