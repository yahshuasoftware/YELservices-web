...
//         // Assuming there is only one department in the response (adjust logic as needed)
//         const department = departments[0];
        
//         // Extracting proofOfIdentity and proofOfAddress from the certificates
//         const certificates = department.certificates;
//         if (certificates && certificates.length > 0) {
//           const proofOfIdentity = certificates[0].proofOfIdentity;
//           const proofOfAddress = certificates[0].proofOfAddress;
          
//           setAvailableIdentityDocs(proofOfIdentity);
//           setAvailableAddressDocs(proofOfAddress);
//           console.log("this is avilability",availableIdentityDocs)
//           console.log("this is proof of identity:",proofOfIdentity)
          
//           // console.log("Proof of Identity:", proofOfIdentity);
